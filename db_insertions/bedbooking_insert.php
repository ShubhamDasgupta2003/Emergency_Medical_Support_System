<?php
    ...
    $query="ALTER TABLE `hospital_info` ADD `email` VARCHAR(100) NOT NULL AFTER `ContactNo`;
    
        ALTER TABLE `patient_booking_info` ADD `email` VARCHAR(100) NOT NULL AFTER `Dob`;";
