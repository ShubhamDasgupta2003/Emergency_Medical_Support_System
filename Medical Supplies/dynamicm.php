...
<body>
 ...
 <header class="header">
    ...
    <div id="cart"> <a href="#" id="user-cart"><i class="fa-solid fa-cart-shopping"></i><span><sup>4</sup></span></a>
...
<section class="body-container">
    <div class="contents">
     ...
     <div class="cards">
          ...
          <?php
            $query="SELECT * FROM medical_supplies_product";
            ...
            if(mysqli_num_rows($result)>0)
         {
          ...
          ?>
            ...
            <div class="card">
                <img src="image/pain relief/<?php echo $row['product_image']; ?>" >
                <div class="card-details">
                    <p class="card-name"><?php echo $row['product_name']; ?></p>
                    <p class="card-address">..... </p>
                    <p class="card-type"><?php echo $row['product_para']; ?></p>
                    <p class="card-fare">&#8377 <?php echo $row['product_rate']; ?></p>
                    <a href="Dynamico.php?pid=<?php echo $row['product_id']?>"><button class="btn btn-secondary-orange">Details</button></a>
                </div>
            </div>
            <?php
            }
