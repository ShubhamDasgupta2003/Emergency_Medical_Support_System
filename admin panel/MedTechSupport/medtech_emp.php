        ...
        <div class="sidebar-menu">
            <ul>
               ...
               <li>
                ...
                <li>
                    <a href="http://localhost/Minor%20Project%205th_Sem/Emergency_Medical_Support_System/admin panel/MedTechSupport/medtech_emp.php" class="active"><span class="las la-clipboard-list"></span>
