<?php
    ...
    $org_id=$rows['org_id'];
    $rows1 = $db->select("medtech_org","*","org_id='$org_id'")->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        ...
        <div class="hspl-details">
            ...
            <div class="c1"><strong class="attribute1">Organization Name:</strong><?php echo $rows1['org_name']?></div>
        </div>
        ...
        <div class="other-details">
            ...
            <div class="c2"><strong class="attribute2">Address:</strong><?php echo $order_rows['user_book_address']?>
            <div class="c1"><strong class="attribute2">Land Mark:</strong><?php echo $order_rows['lmark']?>
